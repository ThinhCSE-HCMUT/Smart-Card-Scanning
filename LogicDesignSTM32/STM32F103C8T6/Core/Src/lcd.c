...
void lcd_print_int(int num) {
    char str[12]; // Buffer to hold the string representation of the integer (up to 10 digits + sign + null terminator)
    sprintf(str, "%d", num); // Convert the integer to a string
    lcd_send_string(str);    // Print the string on the LCD
}
